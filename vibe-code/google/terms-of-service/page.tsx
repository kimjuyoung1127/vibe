  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <section className="mt-8 text-gray-700">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-4">License</h2>
        <p className="mb-4">
        ...
        <h3 className="text-lg font-medium mt-4 mb-2">You must not:</h3>
        ...
        <h2 className="text-xl font-semibold mt-6 mb-4">User Content</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-4">Prohibited Uses</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-4">No Warranties</h2>
        <p className="mb-4">
        ...
        <h2 className="text-xl font-semibold mt-6 mb-4">Limitations</h2>
        <p className="mb-4">
